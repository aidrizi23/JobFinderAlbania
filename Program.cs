...
public class Program
{
    public static void Main(string[] args)
    {
        ...
        builder.Services.AddIdentity<User, IdentityRole<string>>(options =>
            ...
            .AddEntityFrameworkStores<ApplicationDbContext>()  // This line is essential
            .AddDefaultTokenProviders();  // Optional: for password reset and email confirmation tokens
